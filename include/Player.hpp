...
class Player
{
    private:
        ...
        void checkInputs(std::shared_ptr<RayCasting> rayCastingEngine, const unsigned short mousePosX);
    ...
    public:
        ...
        void update(std::shared_ptr<MapManager> mapManager, std::shared_ptr<RayCasting> rayCasting, const unsigned short mousePosX);
